...
{
    public class ORGPDescriptionDutyController : MuseController
    {
        // GET: MGCode/ORGPDescriptionDuty
        ...
        public JsonResult ORGPDescriptionDutyInfo(string qname, int start, int length)
        {
            int total = 0;
            ...
            using (ApplicationDbContext context = new ApplicationDbContext())
            {
                ...
                IQueryable<ORGPDescriptionDuty> Temp = context.Set<ORGPDescriptionDuty>();
        ...
        public JsonResult ORGPDescriptionDuty(string id)
        {
        ...
        [HttpPut]
        public JsonResult PutORGPDescriptionDuty(ORGPDescriptionDuty oData)
        {
            JsonResult json = new JsonResult() { };
            json.JsonRequestBehavior = JsonRequestBehavior.AllowGet;
            ...
            using (ApplicationDbContext context = new ApplicationDbContext())
            {
                ...
                var oTemp = context.Set<ORGPDescriptionDuty>().Where(p => p.Id == oData.Id).First();
        ...
        [HttpPost]
        public JsonResult SaveORGPDescriptionDuty(ORGPDescriptionDuty oData)
        {
            JsonResult json = new JsonResult() { };
            json.JsonRequestBehavior = JsonRequestBehavior.AllowGet;
            ...
            using (ApplicationDbContext context = new ApplicationDbContext())
            {
                ...
                context.Set<ORGPDescriptionDuty>().Add(oData);
        ...
        [HttpDelete]
        public JsonResult DeleteORGPDescriptionDuty(string FID)
        {
            JsonResult json = new JsonResult() { };
            json.JsonRequestBehavior = JsonRequestBehavior.AllowGet;
            try
            {
                using (ApplicationDbContext context = new ApplicationDbContext())
                {
                    var oTemp = context.Set<ORGPDescriptionDuty>().Where(p => p.Id == FID).First();

                    context.ORGPDescriptionDuty.Remove(oTemp);
