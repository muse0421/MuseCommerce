...
app.controller('IndexorgcodeCtrl', function ($scope, $http, $state, $stateParams) {
    ...
    $scope.delete = function (fid) {
        ...
        swal({
            ...
            $http.delete("/MGCode/ORGDepartment/DeleteORGDepartment", config)
            .success(function (response) {
    ...
    $scope.forbidden = function (fid) { 
        var data = { 'fid': fid };
        $http.put("/MGCode/ORGDepartment/forbidden",data)
           .success(function (response) {
               $scope.success = response.success;
               $scope.search();
        });
    ...
    $scope.restore = function (fid) {       
        var data = { 'fid': fid };
        $http.put("/MGCode/ORGDepartment/restore", data)
           .success(function (response) {
               $scope.success = response.success;
               $scope.search();
           });
...
app.controller('EditorgcodeCtrl', function ($scope, $http, $state, $stateParams, $rootScope) {
    ...
    $scope.loadorgcode = function () {
        ...
        $http.get("/MGCode/ORGDepartment/ORGDepartment", config)
    ...
    $scope.save = function () {
        ...
        $http.put("/MGCode/ORGDepartment/PutORGDepartment", data, config)
        .success(function (response) {
            $scope.success = response.success;
...
app.controller('CreateorgcodeCtrl', function ($scope, $http, $state, $stateParams, $rootScope) {
    ...
    $scope.save = function () {
        ...
        var config = {};
        var data = $scope.orgcode;
        $http.post("/MGCode/ORGDepartment/SaveORGDepartment", data, config)
        .success(function (response) {
            $scope.success = response.success;           
            $rootScope.$state.go('index');
        });
